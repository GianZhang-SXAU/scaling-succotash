...
<div align="center">
    ...
    <p style="font-size: larger">欢迎来到信息采集页面</p>
    <h1 style="color: red">${waring}</h1>
</div>
<div align="center">
    <%--@elvariable id="user" type="com"--%>
    <c:form method="post" modelAttribute="user" action="${pageContext.request.contextPath}/user/save">
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <input id="submit" type="submit" value="提交信息并查看结果">
